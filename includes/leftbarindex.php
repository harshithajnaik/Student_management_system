                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="#"><i class="fa fa-user"></i> <span>Admin Login</span> </a></li>
                                            <li><a href="#"><i class="fa fa-user"></i> <span>Teacher Login</span> </a></li>
                                            <li><a href="#"><i class="fa fa-user"></i> <span>Students Login</span></a></li>
                                        </ul>
                                    </li>
