                                        ...
                                        <?php } ?>
                                                ...
                                                <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Academic Year</label>
                                                            <div class="col-sm-10">
                                                                <select name="class" class="form-control clid" id="academic_id" onChange="getStudent(this.value);" required="required">
                                                                <option value="">Select Academic Year</option>
                                                                <?php $sql = "SELECT distinct academic_year from class";
                                                                $query = $dbh->prepare($sql);
                                                                $query->execute();
                                                                ...
                                                                if($query->rowCount() > 0)
                                                                {
                                                                    ...
                                                                    {   ?>
                                                                        <option value="<?php echo htmlentities($result->academic_year); ?>"><?php echo htmlentities($result->academic_year); ?>&nbsp;</option>
                                                                <?php }} ?>
                                                                </select>
                                                            </div>
                                                    </div>
