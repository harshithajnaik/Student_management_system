                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="col-md-2 col-offset-5" style="float:right">
                                            <a href="add-fee.php">
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT fee_config_table.parameter_code,fee_config_table.batch, fee_config_table.parameter_name,fee_config_table.amount_in_Rs, fee_config_table.fee_type, fee_config_table.payment-type, fee_config_table.status  from fee_config_table.parameter_code join class on class.batch=fee_config_table.batch";
